...
$(document).ready(function () {
	...
	$("#copy-to-clipboard").on("click", function () {
			...
			xhr.send("introduce="+html+"&username="+username+"&title="+title);
			xhr.onreadystatechange = function(){
				setTimeout(function() {}, 4000);
				if(xhr.readyState==4 && xhr.status==200){
					alert("表单创建成功！");
					var path = xhr.responseText;
					path = "http://guangnet.site/form/" + path;
					location.href = "../share_page.html"+"?url="+encodeURI(path);
...
function tableList(id) {
	...
	switch (id) {
		case "text":
			...
			var text = '<input type="text" class="form-control col-sm-7" placeholder="请输入文本" name="文本框">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">文本：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "select":
			//下拉框
			var radom = Math.ceil(Math.random() * 100000);
			var select = '<select class="form-control"><option>请选择</option><option>默认</option></select>';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">下拉框：</label><div class="col-sm-7">' + select + '</div><p class="tools col-sm-3"><a class="edit-link" name="select" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "textarea":
			//多行文本
			var radom = Math.ceil(Math.random() * 100000);
			var textarea = '<textarea class="form-control" placeholder="请输入文本" name="多行文本' + radom + '"></textarea>';
		...
		case "radio":
			//单选框
			var radom = Math.ceil(Math.random() * 100000);
			var radio = '<label class="radio-inline"><input type="radio" value="默认1" name="单选框" checked id="radio1' + radom + '"> 默认1</label><label class="radio-inline"><input type="radio" name="单选框" value="默认2" id="radio2' + radom + '"> 默认2</label>';
		...
		case "checkbox":
			//多选框
			var radom = Math.ceil(Math.random() * 100000);
			var checkbox = '<label class="radio-inline" style="padding-left:0px;"><input type="checkbox" name="多选框"> 默认1</label><label class="radio-inline" style="padding-left:0px;"><input type="checkbox" name="多选框"> 默认2</label>';
		...
		case "name":
			//姓名
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control " placeholder="请输入你的姓名" name="姓名">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">姓名：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "phone":
			//电话
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control" placeholder="请输入你的电话" name="电话">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">电话：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "email":
			//邮箱
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control" placeholder="请输入你的邮箱" name="邮箱">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">邮箱：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "card":
			//身份证
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control" placeholder="请输入你的身份证" name="身份证">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">身份证：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "www":
			//网址
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control" placeholder="请输入你的个人网站地址" name="网址">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">个人网站：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "logo":
			//标志
			var radom = Math.ceil(Math.random() * 100000);
			var file = '<input class="file uploadfile" type="file" multiple data-min-file-count="1" name="标志">';
		...
		case "sex":
			//性别
			var radom = Math.ceil(Math.random() * 100000);
			var radio = '<label class="radio-inline"><input type="radio" value="男"  name="性别" checked> 男</label><label class="radio-inline"><input type="radio" name="性别" value="女"> 女</label>';
		...
		case "occupation":
			//职位
			var radom = Math.ceil(Math.random() * 100000);
			var text = '<input type="text" class="form-control" placeholder="请输入你的职位" name="职位">';
			content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">职位：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa fa-cog fa-fw"></i></a><a class="remove-link"><i class="fa fa-trash-o"></i></a><label class="labcheck"></label></p></div>';
			break;
		case "profile":
			//个人简介
			var radom = Math.ceil(Math.random() * 100000);
			var textarea = '<textarea class="form-control" placeholder="请输入你的简介" name="个人简历"></textarea>';
...
function tabUp(tabL, $el) {
	...
	switch (tabL) {
		...
		case "textarea":
			//多行文本
			var radom = Math.ceil(Math.random() * 100000);
			content = '<div class="row tabup"><div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">标题：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) + '" placeholder="请输入标题" name="textarea' + radom + '"></div></div><div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">提示信息：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("textarea").attr("placeholder") + '" placeholder="请输入提示信息"></div></div></div>';
			break;
		case "radio":
			//单选框
			content += '<div class="row tabup">';
			content += '<div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">标题：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) + '" placeholder="请输入标题" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'"></div></div>';
		...
		case "checkbox":
			...
			var radom = Math.ceil(Math.random() * 100000);
			content += '<div class="row tabup">';
			content += '<div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">标题：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) + '" placeholder="请输入标题" name="checkbox' + radom + '"></div></div>';
			content += '<div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">子项1：</label><div class="col-sm-8"><input type="text" class="form-control" value="' + $el.find("input[type='checkbox']:eq(0)").attr("name") + '" placeholder="请输入子项" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'[]"></div><label class="col-sm-1 control-label"><i class="fa fa-plus-square select-add" title="添加" style="font-size:18px; cursor:pointer;"></i></label></div>';
			content += '<div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">子项2：</label><div class="col-sm-8"><input type="text" class="form-control" value="' + $el.find("input[type='checkbox']:eq(1)").attr("name") + '" placeholder="请输入子项" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'[]"></div><label class="col-sm-1 control-label"></label></div>';
			$el.find("input[type='checkbox']").each(function (index) {
				if (index > 1) {
					content += '<div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">子项' + (index + 1) + '：</label><div class="col-sm-8"><input type="text" class="form-control" value="' + $(this).attr("name") + '" placeholder="请输入子项" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'[]"></div><label class="col-sm-1 control-label"><i class="fa fa-trash-o select-del" title="删除" style="font-size:18px; cursor:pointer;"></i></label></div>';
				}
			});
			content += '</div>';
			break;
		...
		case "file":
			//上传
			content = '<div class="row tabup"><div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">标题：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) + '" placeholder="请输入标题" id="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'"></div></div></div>';
			break;
		case "picker":
			//省市区
			content = '<div class="row tabup"><div class="col-sm-12" style="margin-bottom:10px"><label class="col-sm-3 control-label">标题：</label><div class="col-sm-9"><input type="text" class="form-control" value="' + $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) + '" placeholder="请输入标题" id=""></div></div></div>';
			break;
	}
	return content;
}
					...
					$(this).parent().find("input").each(function (index, element) {
						if (index == 0) {
							...
							if ($(this).val() == "") {
								...
								option += '<label class="radio-inline"><input type="radio" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'"  value="' + $(this).val() + '" checked="" id="radio' + radom + '"> ' + $(this).val() + '</label>';
							}
						} else {
							if ($(this).val() == "") {
								panduan = 1;
								...
								option += '<label class="radio-inline"><input type="radio" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'" value="' + $(this).val() + '" id="radio' + radom + '"> ' + $(this).val() + '</label>';
							}
						}
					});
					if (panduan != 0) {
					...
					$(this).parent().find("input").each(function (index, element) {
						if (index == 0) {
							...
							if ($(this).val() == "") {
								...
								option += '<label class="radio-inline"><input type="checkbox" name="'+ $el.find("label:eq(0)").html().substring(0, $el.find("label:eq(0)").html().length - 1) +'[]" value="'+$(this).val() +'" id="checkbox' + radom + '"> ' + $(this).val() + '</label>';
							}
						} else {
							if ($(this).val() == "") {
								panduan = 1;
