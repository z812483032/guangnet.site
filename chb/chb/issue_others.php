<?php
	...
	$pageSize=20;
	$result=mysqli_query($db,"select * from table_others where issuer='$issuer'");
	...
	$result1=mysqli_query($db,"select * from table_others where issuer='$issuer' limit $start,$pageSize");


$id=1;
	echo"<h3 align=center>曾经发布过的生活用品信息</h3>";
...
?>
  ...
  <?php
	  ...
	  $sql="delete from table_others where others_id in($snos)";
